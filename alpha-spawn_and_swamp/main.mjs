...
import { WORK, TOUGH, CARRY, MOVE, ATTACK, RESOURCE_ENERGY, ERR_NOT_IN_RANGE, RANGED_ATTACK} from 'game/constants'
...
function getEnemies() {
  return getObjectsByPrototype(Creep).filter(creep => !creep.my && creep.body.some(part => [ATTACK, RANGED_ATTACK].includes(part.type)))
}
